# Generated by Django 4.2.21 on 2025-05-14 07:13

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import idvalid_core.generators
import oauth.models.base
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(oauth.models.base.TemporaryUser, models.Model),
        ),
        migrations.CreateModel(
            name='Application',
            fields=[
                ...
                ('prompt_callback_url', models.URLField(blank=True, null=True, verbose_name='prompt callback url')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.TextField(blank=True, choices=[('accepted', 'Accepted'), ('rejected', 'Rejected')], max_length=32, null=True, verbose_name='answer')),
