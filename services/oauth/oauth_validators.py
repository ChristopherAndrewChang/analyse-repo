...
def get_oidc_issuer(request):
    ...
    abs_url = django_request.build_absolute_uri(reverse("oauth:oidc-connect-discovery-info"))
...
class OAuth2Validator(RequestValidator):
    ...
    def _save_bearer_token(self, token, request, *args, **kwargs):
        ...
        if refresh_token_code:
            ...
            if (
                ...
                access_token.user_id = request.user.pk
    ...
    def get_id_token_dictionary(self, token, token_handler, request):
        ...
        claims.update(
            **{
                ...
                "auth_time": int(dateformat.format(timezone.now(), "U")),
                "jti": str(uuid.uuid4()),
            }
        )
    ...
    def get_oidc_issuer_endpoint(self, request):
        return get_oidc_issuer(request)
    ...
    def validate_user_match(self, id_token_hint, scopes, claims, request):
        ...
        # https://gitub.com/idan/oauthlib/blob/master/oauthlib/oauth2/rfc6749/request_validator.py#L556
        # http:h//openid.net/specs/openid-connect-core-1_0.html#AuthRequest id_token_hint section
        return True
